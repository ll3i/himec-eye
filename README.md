...
현장 사진 1장을 **직무별 전용 모델**이 판독하고, 공통 룰엔진이 **근거 조항 · 위험도 · 조치사항**을
붙여 지적사항을 산출합니다.
...
| 직무 | mAP@50 | Precision | Recall |
|---|---:|---:|---:|
| 안전관리 | 31.6% | 37.5% | 33.9% |
| 시설·설비 관리 | 45.8% | 65.6% | 42.7% |
| 생산 품질검사 | 32.6% | 45.5% | 39.2% |
| 2차전지 셀 선별 | 99.5% | 100.0% | 100.0% |
| 물류·운송 관리 | 66.8% | 88.0% | 64.1% |
| 주차 운영관리 | 71.5% | 70.6% | 69.9% |

GPU 없이 CPU에서 제한된 epoch만 학습한 프로토타입 수치입니다.
2차전지 99.5%는 합성 데이터로 방법론을 검증한 값이며, 도입 시 실제 셀 이미지로 재학습이 필요합니다.
