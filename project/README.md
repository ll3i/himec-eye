...
현장 사진 1장을 직무별 전용 모델이 판독하고, 공통 룰엔진이 **근거 조항 · 위험도 · 조치사항**을 붙여
지적사항을 산출합니다. 지게차와 작업자를 각각 검출하는 것만으로는 나오지 않는 판정을 만듭니다.

[![시연 영상](docs/demo.gif)](https://youtu.be/KwVEdUqCQhc)

> 위 화면은 실제 판독 결과입니다 — 지게차 작업반경과 작업자 박스의 겹침으로 협착 위험을 판정합니다.
> **[전체 영상 보기 (36초 · 4개 현장)](https://youtu.be/KwVEdUqCQhc)**  ·  **[온라인 시연 열기](https://himec-eye-panel.vercel.app)**
